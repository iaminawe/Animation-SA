...
INSTALLATION
------------
1. Install the jquery_update module.
2. Copy avatar_selection folder to modules directory.
3. At admin/build/modules enable the avatar selection module.
4. Enable permissions at admin/user/access.
5. Configure the module at admin/settings/avatar_selection.
