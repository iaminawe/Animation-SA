<?php
// $Id: advanced_profile_view_user-list.tpl.php,v 1.2.2.5 2009/01/16 02:46:25 michellec Exp $
...
$author_pane = theme_author_pane($account, advanced_profile_path_to_images(), 'advanced_profile_author-pane');
?>
