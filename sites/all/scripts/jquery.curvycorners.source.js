...
function curvyObject() {
	...
	// Style/fix
	$(this.box).css({"padding":"0px", "borderColor":this.borderColour});
    ...
    this.applyCorners = function() {
		...
		if(this.settings.autoPad == true) {
			...
			$(contentContainer2).css({ margin:"0","padding-bottom":this.boxPaddingBottom,"padding-top":this.boxPaddingTop,"padding-left":this.boxPaddingLeft,"padding-right":this.boxPaddingRight});
