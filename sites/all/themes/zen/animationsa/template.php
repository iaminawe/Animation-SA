 ...
 *   animationsa_regions()
 * where animationsa is the name of your sub-theme. For example, the zen_classic
 ...
 * use these functions:
 *   animationsa_preprocess_page(&$vars)     to add variables to the page.tpl.php
 *   animationsa_preprocess_node(&$vars)     to add variables to the node.tpl.php
 *   animationsa_preprocess_comment(&$vars)  to add variables to the comment.tpl.php
 *   animationsa_preprocess_block(&$vars)    to add variables to the block.tpl.php
 */
...
drupal_add_css(path_to_subtheme() .'/animationsa.css', 'theme', 'all');
 ...
 */
/* -- Delete this line if you want to use this function
function animationsa_preprocess(&$vars, $hook) animationsa
// */
 ...
 */
/* -- Delete this line if you want to use this function
function animationsa_preprocess_page(&$vars) {
 ...
 */
/* -- Delete this line if you want to use this function
function animationsa_preprocess_node(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function animationsa_preprocess_comment(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function animationsa_preprocess_block(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
